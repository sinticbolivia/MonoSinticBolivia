...
{
    /// <summary>
    /// necessary changes into etc/mono/config file over windows OS.
    ...
    public class Ean13
    {
        ...
        #region -- drawing barcode --
        public void DrawEan13Barcode( System.Drawing.Graphics g, System.Drawing.Point pt, string barcode = "" )
        {
            ...
            sLeftPattern = this.ConvertLeftPattern( sTemp.Substring( 0, 7 ) );
        ...
        public System.Drawing.Bitmap CreateBitmap(string barcode = "", int w = 0, int h = 0 )
        {
            ...
            this.DrawEan13Barcode( g, new System.Drawing.Point( 0, 0 ), barcode );
            g.Dispose( );

            return bmp;
        }
        #endregion -- drawing barcode --
